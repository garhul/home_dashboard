...
const baseCfg = {
    ...
    rules: {
        filePath: process.env.RULES_FILE || path_1.default.resolve('/data', 'rules.json'),
    }
};
const prod = {
    mockDevices: false,
    mockSensors: false,
    sensors: {
        dataPath: process.env.SENSOR_DATA_PATH || path_1.default.resolve('/data'),
